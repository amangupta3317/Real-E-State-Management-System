...
import ghar from "../components/img1.jpg";
export default function Home() {
  ...
  return (
    ...
    <div className="bg-yellow-100 mt-8  ">
      {/* top */}
      <div className=" flex flex-col lg:flex-row gap-6 p-20 px-3 max-w-6xl mx-auto lg:items-center ">
        <div className="lg:w-1/2 ">
          ...
          <div className="  mt-7">
            Explore our curated selection of premium properties, designed to
            match your lifestyle and preferences.
            <br />
            Browse through a diverse range of listings, offering options to buy
            or sell your dream estate
          </div>
          <Link
            to={"/search"}
        ...
        <img className="lg:w-1/2 rounded-lg shadow-lg" src={ghar} alt="" />
      </div>
